...
DROP TABLE IF EXISTS deal_tracker.alternative_deals CASCADE;
DROP TABLE IF EXISTS deal_tracker.price_history CASCADE;
DROP TABLE IF EXISTS deal_tracker.products CASCADE;
...
CREATE INDEX idx_products_user_email ON deal_tracker.products(user_email);
CREATE INDEX idx_products_created_at ON deal_tracker.products(created_at DESC);
CREATE INDEX idx_price_history_product_id ON deal_tracker.price_history(product_id);
CREATE INDEX idx_price_history_created_at ON deal_tracker.price_history(created_at DESC);
CREATE INDEX idx_alternative_deals_product_id ON deal_tracker.alternative_deals(product_id);
CREATE INDEX idx_alternative_deals_price ON deal_tracker.alternative_deals(price);
